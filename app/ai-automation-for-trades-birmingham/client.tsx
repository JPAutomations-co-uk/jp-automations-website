...
export default function BirminghamClient() {
  return (
    <HomeClient hideHero>
        ...
        <div className="relative z-[1] max-w-[var(--content-max)] mx-auto px-5 md:px-[var(--gutter)] py-[clamp(48px,7vw,100px)]">
          <FadeUp>
            <div className="section-label mb-4 md:mb-6">
              <span>AI Automation for Trades in Birmingham</span>
            </div>
          </FadeUp>
          <FadeUp delay={0.1}>
            <h1
          ...
          <FadeUp delay={0.2}>
            <p className="text-sm md:text-[17px] leading-[1.75] max-w-[600px] mb-8 md:mb-10" style={{ fontFamily: "var(--font-body)", color: "var(--text-secondary)" }}>
              Birmingham tradespeople are losing thousands every month to missed calls, late invoices, and leads that go cold. We build the systems that fix it.
            </p>
          </FadeUp>
          <FadeUp delay={0.3}>
        ...
        <div className="max-w-[var(--content-max)] mx-auto px-5 md:px-[var(--gutter)]">
          <FadeUp className="mb-10 md:mb-14">
            <div className="section-label">
              <span>Why Birmingham</span>
            </div>
            <h2 className="h1">THE UK&apos;S SECOND<br />CITY RUNS ON TRADES.</h2>
          </FadeUp>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">
            ...
            >
              ...
              <p className="text-[13px] md:text-sm leading-[1.75]" style={{ fontFamily: "var(--font-body)", color: "rgba(255,255,255,.5)" }}>
                Over 1.1 million people and one of the fastest-growing construction sectors outside London. The demand is there. The question is whether you can handle it without drowning in admin.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-[13px] md:text-sm leading-[1.75]" style={{ fontFamily: "var(--font-body)", color: "rgba(255,255,255,.5)" }}>
                HS2, the Smithfield redevelopment, and thousands of residential projects across the West Midlands. Birmingham&apos;s trades are busier than ever &mdash; and the ones without systems are the ones burning out.
              </p>
            </motion.div>
            ...
            >
              <h3 className="h3 mb-3" style={{ fontSize: "clamp(18px, 2vw, 24px)", lineHeight: 1.15 }}>
                Proven in Birmingham
              </h3>
              <p className="text-[13px] md:text-sm leading-[1.75]" style={{ fontFamily: "var(--font-body)", color: "rgba(255,255,255,.5)" }}>
                A 3-man roofing crew in Birmingham dropped their outstanding invoices from &pound;8,400 to &pound;320 in eight weeks. Same crew, same jobs &mdash; just a system that actually chases payment.
              </p>
            </motion.div>
          </div>
        </div>
