        ...
        <div className="relative z-[1] max-w-[var(--content-max)] mx-auto px-5 md:px-[var(--gutter)] py-[clamp(48px,7vw,100px)]">
          <FadeUp>
            <div className="section-label mb-4 md:mb-6">
              <span>AI Automation for Trades in Bristol</span>
            </div>
          </FadeUp>
          <FadeUp delay={0.1}>
            <h1
          ...
          <FadeUp delay={0.2}>
            <p className="text-sm md:text-[17px] leading-[1.75] max-w-[600px] mb-8 md:mb-10" style={{ fontFamily: "var(--font-body)", color: "var(--text-secondary)" }}>
              Bristol&apos;s trade businesses are growing fast. The ones with systems scale cleanly. The rest drown in spreadsheets and missed calls. We build the systems.
            </p>
          </FadeUp>
          <FadeUp delay={0.3}>
        ...
        <div className="max-w-[var(--content-max)] mx-auto px-5 md:px-[var(--gutter)]">
          <FadeUp className="mb-10 md:mb-14">
            <div className="section-label">
              <span>Why Bristol</span>
            </div>
            <h2 className="h1">THE SOUTH WEST&apos;S<br />TRADE HUB.</h2>
          </FadeUp>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">
            ...
            >
              ...
              <p className="text-[13px] md:text-sm leading-[1.75]" style={{ fontFamily: "var(--font-body)", color: "rgba(255,255,255,.5)" }}>
                Bristol&apos;s property prices have outpaced almost every UK city outside London. That means constant renovation, new builds, and extensions across the city. Trade businesses in Bristol, Bath, and across the South West are stretched to capacity.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-[13px] md:text-sm leading-[1.75]" style={{ fontFamily: "var(--font-body)", color: "rgba(255,255,255,.5)" }}>
                Bristol leads the UK in green retrofit and sustainable construction. EPC upgrades, heat pump installations, and insulation projects are creating a wave of work for trades who can manage the compliance paperwork. Automation handles the paperwork.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-[13px] md:text-sm leading-[1.75]" style={{ fontFamily: "var(--font-body)", color: "rgba(255,255,255,.5)" }}>
                A Bristol builder&apos;s margins went from 8% to 16% after we automated their job costing and CIS returns. Same jobs, same team &mdash; just live visibility on what every project was actually costing them instead of finding out three months later.
              </p>
            </motion.div>
          </div>
        </div>
