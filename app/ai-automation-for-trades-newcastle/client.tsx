...
export default function NewcastleClient() {
  return (
    <HomeClient hideHero>
        ...
        <div className="relative z-[1] max-w-[var(--content-max)] mx-auto px-5 md:px-[var(--gutter)] py-[clamp(48px,7vw,100px)]">
          <FadeUp>
            <div className="section-label mb-4 md:mb-6">
              <span>AI Automation for Trades in Newcastle</span>
            </div>
          </FadeUp>
          <FadeUp delay={0.1}>
            <h1
          ...
          <FadeUp delay={0.2}>
            <p className="text-sm md:text-[17px] leading-[1.75] max-w-[600px] mb-8 md:mb-10" style={{ fontFamily: "var(--font-body)", color: "var(--text-secondary)" }}>
              Newcastle&apos;s trades are as hard-working as anywhere in the UK. The problem isn&apos;t the work — it&apos;s what surrounds it. Missed calls, late invoices, admin that eats the evenings. We eliminate all of it.
            </p>
          </FadeUp>
          <FadeUp delay={0.3}>
      ...
      >
        <div className="max-w-[var(--content-max)] mx-auto px-5 md:px-[var(--gutter)]">
          <FadeUp className="mb-10 md:mb-14">
            ...
            <h2 className="h1">THE NORTH EAST<br />RUNS ON GRAFT.</h2>
          </FadeUp>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">
            ...
            >
              ...
              <p className="text-[13px] md:text-sm leading-[1.75]" style={{ fontFamily: "var(--font-body)", color: "rgba(255,255,255,.5)" }}>
                Newcastle, Gateshead, Sunderland, and the wider Tyne &amp; Wear region represent over a million people and a dense, older housing stock. Demand for qualified tradespeople is consistent and growing.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-[13px] md:text-sm leading-[1.75]" style={{ fontFamily: "var(--font-body)", color: "rgba(255,255,255,.5)" }}>
                Major investment in Newcastle&apos;s Quayside, Ouseburn, and South Gateshead is driving a wave of commercial refurbishments and residential conversions. Trades with solid systems are winning more of this work.
              </p>
            </motion.div>
            ...
            >
              <h3 className="h3 mb-3" style={{ fontSize: "clamp(18px, 2vw, 24px)", lineHeight: 1.15 }}>
                The Same Problems, Fixed
              </h3>
              <p className="text-[13px] md:text-sm leading-[1.75]" style={{ fontFamily: "var(--font-body)", color: "rgba(255,255,255,.5)" }}>
                Whether you&apos;re in Jesmond or Wallsend, the problems are the same: unpaid invoices sitting there, calls you couldn&apos;t answer, evenings spent doing admin instead of being at home. We&apos;ve fixed this for trades across the UK.
              </p>
            </motion.div>
          </div>
        </div>
