...
export default function LiverpoolClient() {
  return (
    <HomeClient hideHero>
        ...
        <div className="relative z-[1] max-w-[var(--content-max)] mx-auto px-5 md:px-[var(--gutter)] py-[clamp(48px,7vw,100px)]">
          <FadeUp>
            <div className="section-label mb-4 md:mb-6">
              <span>AI Automation for Trades in Liverpool</span>
            </div>
          </FadeUp>
          <FadeUp delay={0.1}>
            <h1
          ...
          <FadeUp delay={0.2}>
            <p className="text-sm md:text-[17px] leading-[1.75] max-w-[600px] mb-8 md:mb-10" style={{ fontFamily: "var(--font-body)", color: "var(--text-secondary)" }}>
              Liverpool&apos;s trades have no shortage of work. What they&apos;re short on is time — lost to invoicing, missed calls, and follow-ups that never happen. We fix the systems so the work stays profitable.
            </p>
          </FadeUp>
          <FadeUp delay={0.3}>
      ...
      >
        <div className="max-w-[var(--content-max)] mx-auto px-5 md:px-[var(--gutter)]">
          <FadeUp className="mb-10 md:mb-14">
            ...
            <h2 className="h1">MERSEYSIDE KEEPS<br />BUILDING. NON-STOP.</h2>
          </FadeUp>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">
            ...
            >
              ...
              <p className="text-[13px] md:text-sm leading-[1.75]" style={{ fontFamily: "var(--font-body)", color: "rgba(255,255,255,.5)" }}>
                Liverpool&apos;s waterfront, the Knowledge Quarter, and thousands of residential conversions across Toxteth, Everton, and Kirkdale mean trade businesses are fielding more enquiries than they can handle without proper systems.
              </p>
            </motion.div>
            ...
            >
              <h3 className="h3 mb-3" style={{ fontSize: "clamp(18px, 2vw, 24px)", lineHeight: 1.15 }}>
                Old Housing, Constant Demand
              </h3>
              <p className="text-[13px] md:text-sm leading-[1.75]" style={{ fontFamily: "var(--font-body)", color: "rgba(255,255,255,.5)" }}>
                Liverpool has one of the highest concentrations of pre-1919 housing stock in England. That means roofers, plumbers, and electricians are never short of work — but they&apos;re also never short of paperwork.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-[13px] md:text-sm leading-[1.75]" style={{ fontFamily: "var(--font-body)", color: "rgba(255,255,255,.5)" }}>
                On Checkatrade and Google, Merseyside customers contact three or four trades and go with whoever responds first. If you&apos;re on a job and your phone rings unanswered, that&apos;s someone else&apos;s invoice, not yours.
              </p>
            </motion.div>
          </div>
        </div>
