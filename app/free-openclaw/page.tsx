...
export default function FreeOpenClawPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch('/api/lead-openclaw', {
        method: 'POST',
    ...
    <main className="relative min-h-screen bg-[#0B0F14] flex items-center justify-center overflow-hidden px-6 py-24">
      ...
      <div className="relative z-10 w-full max-w-xl text-center">
        ...
        <p className="text-gray-400 text-[17px] leading-[1.7] mb-6 max-w-md mx-auto">
          OpenClaw sits inside your inbox, calendar, and client files. Here&apos;s how to use it without putting your data — or your clients&apos; data — at risk.
        </p>
        ...
        <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl px-6 py-5 mb-8 text-left">
          ...
          <div className="space-y-3">
            {[
              "What Cisco's security team actually found — and why it matters",
              'Which data is exposed and what a malicious skill can silently access',
              'How to audit every skill installed on your system right now',
              'A safe configuration checklist before you go live',
              'How to isolate OpenClaw from sensitive client data',
            ].map((item) => (
