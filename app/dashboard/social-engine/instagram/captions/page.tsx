...
export default function SEOCaptionsPage() {
  ...
  const handleGenerate = useCallback(async () => {
    ...
    if (!user) {
      router.push("/login?redirect=/dashboard/social-engine/instagram/captions")
      return
    }
    ...
    <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="flex gap-1 p-1 bg-white/[0.03] border border-white/[0.08] rounded-xl mb-6 max-w-2xl">
              <a href="/dashboard/social-engine/instagram" className="flex-1 py-2.5 px-2 text-sm font-semibold text-center rounded-lg text-gray-500 hover:text-gray-300 transition-all">
                Generate
              </a>
              ...
              <a href="/dashboard/social-engine/instagram/ads" className="flex-1 py-2.5 px-2 text-sm font-semibold text-center rounded-lg text-gray-500 hover:text-gray-300 transition-all">
                Ads
              </a>
              <a href="/dashboard/social-engine/instagram/reels" className="flex-1 py-2.5 px-2 text-sm font-semibold text-center rounded-lg text-gray-500 hover:text-gray-300 transition-all">
                Reels
              </a>
            </div>
