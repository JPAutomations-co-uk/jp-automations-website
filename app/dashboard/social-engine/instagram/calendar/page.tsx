        ...
        <div className="min-h-screen bg-[#0a0a0a] text-white font-[family-name:var(--font-geist-sans)]">
            ...
            <main className="relative z-10 pt-36 md:pt-44 pb-24 px-6 max-w-7xl mx-auto">
                ...
                <div className="flex items-end justify-between mb-8">
                    <div>
                        <Link href="/dashboard/social-engine/instagram" className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-teal-400 transition-colors mb-4 group">
