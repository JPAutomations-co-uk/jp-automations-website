...
export default function CreateReelPage() {
  ...
  const handleAnalyze = useCallback(async () => {
    ...
    if (!user) {
      router.push("/login?redirect=/dashboard/instagram/reels/create")
      return
    }
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white font-[family-name:var(--font-geist-sans)]">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            {user ? (
              ...
              <a href="/login?redirect=/dashboard/instagram/reels/create" className="px-5 py-2.5 text-sm font-semibold bg-teal-400 text-black rounded-lg hover:bg-teal-300 transition-all">Sign In</a>
            )}
          </div>
      ...
      <main className="relative z-10 pt-36 md:pt-44 pb-24 px-6">
        <div className="max-w-3xl mx-auto space-y-8">
          {/* Back link */}
          <a href="/dashboard/instagram/reels" className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-teal-400 transition-colors group">
