...
export default function MorePageSections() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Staggered lists (Fit/Not Fit)
      const listSections = gsap.utils.toArray<HTMLElement>('.stagger-list')
      ...
      // Dashboard Stats count up effect or simple stagger pop
      ...
      // 3-Step Architecture Blueprint connection lines
  ...
  return (
    <div ref={containerRef}>
      ...
      <section id="proof" className="reveal-section relative z-10 pt-0 pb-16 md:pb-20 border-t border-white/5 overflow-hidden">
          ...
          <div className="overflow-hidden">
            <div className="marquee-track">
              <div className="marquee-content">
                ...
                ] as MarqueeClient[]).map((client, i) => (
                  <div key={`client-first-${i}`} className="flex-shrink-0 mx-3 md:mx-4">
                    <div className="group w-[280px] md:w-[320px] p-5 md:p-6 rounded-xl bg-white/[0.02] border border-white/10 hover:border-teal-500/40 hover:bg-white/[0.04] hover:shadow-[0_10px_40px_rgba(45,212,191,0.1)] transition-all duration-500 hover:scale-[1.02] relative before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_bottom,rgba(45,212,191,0.1)_0,transparent_70%)] before:opacity-0 hover:before:opacity-100 flex flex-col">
                      ...
                      {client.caseStudy ? (
                        <a href={client.caseStudy} className="inline-flex items-center gap-1.5 text-xs font-medium text-teal-400 hover:text-teal-300 transition-colors group/link">
                          {client.ctaText || "See the full case study"} <span className="transition-transform group-hover/link:translate-x-0.5">→</span>
                        </a>
                      ) : (
              ...
              <div className="marquee-content">
                {([
                  ...
                  <div key={`second-${i}`} className="flex-shrink-0 mx-3 md:mx-4">
                    <div className="group w-[280px] md:w-[320px] p-5 md:p-6 rounded-xl bg-white/[0.02] border border-white/10 hover:border-teal-500/40 hover:bg-white/[0.04] hover:shadow-[0_10px_40px_rgba(45,212,191,0.1)] transition-all duration-500 hover:scale-[1.02] relative before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_bottom,rgba(45,212,191,0.1)_0,transparent_70%)] before:opacity-0 hover:before:opacity-100 flex flex-col">
                      <div className="h-10 md:h-12 mb-4 flex items-center">
                        <img
                          src={client.logo}
      ...
      <section id="process" className="reveal-section relative z-10 py-28 md:py-36 px-6 border-t border-white/5">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="blueprint-container grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            <div className="blueprint-line absolute top-[52px] -left-4 -right-4 h-px bg-gradient-to-r from-transparent via-teal-500/30 to-transparent z-0 max-md:hidden" />
            <div className="step-card step-card group rounded-2xl bg-black/60 backdrop-blur-md border border-white/10 p-8 transition-all duration-500 hover:border-teal-500/40 hover:-translate-y-2 hover:shadow-[0_20px_60px_rgba(45,212,191,0.1)] relative overflow-hidden z-10">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-6">
                  <div className="flex h-14 w-14 items-center justify-center rounded-full bg-black/80 text-teal-400 font-mono text-lg font-bold border border-teal-500/30 group-hover:bg-teal-500/10 group-hover:border-teal-400 group-hover:shadow-[0_0_20px_rgba(45,212,191,0.3)] transition-all duration-500 z-20 relative">1</div>
                  <h3 className="text-2xl font-bold text-white group-hover:text-teal-400 transition-colors">Audit</h3>
                </div>
                <p className="text-gray-400 leading-relaxed mb-8">We tear apart your operations to find exactly where time and money are leaking — and what should never require you.</p>
                <ul className="stagger-list space-y-4">
                  {[
                    ...
                    <li key={item} className="flex items-start gap-3 text-[13px] text-gray-400 font-mono tracking-tight">
            ...
            <div className="step-card step-card group rounded-2xl bg-black/60 backdrop-blur-md border border-white/10 p-8 transition-all duration-500 hover:border-teal-500/40 hover:-translate-y-2 hover:shadow-[0_20px_60px_rgba(45,212,191,0.1)] relative overflow-hidden z-10">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-6">
                  <div className="flex h-14 w-14 items-center justify-center rounded-full bg-black/80 text-teal-400 font-mono text-lg font-bold border border-teal-500/30 group-hover:bg-teal-500/10 group-hover:border-teal-400 group-hover:shadow-[0_0_20px_rgba(45,212,191,0.3)] transition-all duration-500 z-20 relative">2</div>
                  <h3 className="text-2xl font-bold text-white group-hover:text-teal-400 transition-colors">Consultation</h3>
                </div>
                <p className="text-gray-400 leading-relaxed mb-8">We present a clear roadmap with priorities, timelines, and expected outcomes — then we get to work.</p>
                <ul className="stagger-list space-y-4">
                  {[
            ...
            <div className="step-card step-card group rounded-2xl bg-black/60 backdrop-blur-md border border-white/10 p-8 transition-all duration-500 hover:border-teal-500/40 hover:-translate-y-2 hover:shadow-[0_20px_60px_rgba(45,212,191,0.1)] relative overflow-hidden z-10">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-6">
                  <div className="flex h-14 w-14 items-center justify-center rounded-full bg-black/80 text-teal-400 font-mono text-lg font-bold border border-teal-500/30 group-hover:bg-teal-500/10 group-hover:border-teal-400 group-hover:shadow-[0_0_20px_rgba(45,212,191,0.3)] transition-all duration-500 z-20 relative">3</div>
                  <h3 className="text-2xl font-bold text-white group-hover:text-teal-400 transition-colors">Action</h3>
                </div>
                <p className="text-gray-400 leading-relaxed mb-8">We build, deploy, and test every system against your real workflows — then refine until it runs without you.</p>
                <ul className="stagger-list space-y-4">
                  {[
          ...
          <div className="mt-16 text-center">
            <a href="/apply" className="group inline-flex items-center gap-2 px-8 py-4 bg-teal-400 text-black rounded-xl font-semibold hover:bg-teal-300 transition-all hover:scale-105 hover:shadow-[0_0_30px_rgba(45,212,191,0.5)]">
              Book a Call
      ...
      <section id="guarantees" className="reveal-section relative z-10 py-28 md:py-36 px-6 border-t border-white/5">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/[0.08] rounded-2xl overflow-hidden mb-20 border border-white/5">
            <div className="bg-black p-8 md:p-10">
              <p className="text-xs uppercase tracking-[0.2em] text-teal-400 mb-4 font-mono font-medium">Time</p>
              <h3 className="text-lg font-semibold text-white mb-3 leading-snug">25+ hours back per week — or we rebuild it for free</h3>
              <p className="text-gray-500 leading-relaxed text-sm">Our average client reclaims a full working day before the first month is over.</p>
            </div>
            <div className="bg-black p-8 md:p-10">
              <p className="text-xs uppercase tracking-[0.2em] text-teal-400 mb-4 font-mono font-medium">ROI</p>
              <h3 className="text-lg font-semibold text-white mb-3 leading-snug">Recover your investment within 90 days — or we keep working</h3>
              <p className="text-gray-500 leading-relaxed text-sm">One client recovered £10,000+ in the first month alone. We don&apos;t stop until the numbers prove it.</p>
            </div>
            <div className="bg-black p-8 md:p-10">
              <p className="text-xs uppercase tracking-[0.2em] text-teal-400 mb-4 font-mono font-medium">Speed</p>
              <h3 className="text-lg font-semibold text-white mb-3 leading-snug">Systems live within 14 days — not 14 meetings</h3>
              <p className="text-gray-500 leading-relaxed text-sm">From audit to deployed infrastructure in under a month. No committees. No delays.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-px bg-white/[0.06] rounded-2xl overflow-hidden">
            {[
              ...
              <div key={item.stat} className="stat-card bg-black py-8 md:py-10 px-6 text-center">
                <span className="text-4xl md:text-5xl lg:text-5xl font-semibold text-teal-400 tracking-tighter block font-mono animate-pulse-teal">{item.stat}</span>
      ...
      <section id="fit" className="reveal-section relative z-10 py-28 md:py-36 px-6 border-t border-white/5">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="rounded-xl bg-black border border-teal-500/30 p-8 shadow-[0_10px_40px_rgba(45,212,191,0.08)] relative overflow-hidden before:absolute before:top-0 before:left-0 before:w-full before:h-1 before:bg-gradient-to-r before:from-teal-500/10 before:via-teal-400 before:to-teal-500/10">
            ...
            <div className="rounded-xl bg-black/50 border border-white/10 p-8 relative overflow-hidden before:absolute before:top-0 before:left-0 before:w-full before:h-1 before:bg-white/10">
              ...
              <ul className="stagger-list space-y-4">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3 text-[13px] text-gray-400 font-mono tracking-tight leading-relaxed">
      ...
      {/* --- BLOG SECTION --- */}
      <section id="blog" className="reveal-section relative z-10 py-28 md:py-36 border-t border-white/5 bg-[#020408]">
        <div className="max-w-7xl mx-auto px-6">
            ...
            {[
              ...
              <a key={post.slug} href={post.slug} className="group block rounded-2xl overflow-hidden bg-white/[0.02] border border-white/5 hover:border-teal-500/30 transition-all duration-300 hover:shadow-[0_0_30px_rgba(45,212,191,0.1)]">
                ...
                <div className="p-6">
                  ...
                  <p className="text-[13px] text-gray-400 font-mono tracking-tight leading-relaxed leading-relaxed mb-6 line-clamp-2">{post.excerpt}</p>
          ...
          <div className="mt-16 flex justify-center">
            <a href="/blog" className="group px-8 py-4 border-2 border-teal-400 text-teal-400 rounded-xl font-semibold hover:bg-teal-400 hover:text-black transition-all duration-300 inline-flex items-center gap-2">
              View all blog posts <span className="transition-transform group-hover:translate-x-1">→</span>
            </a>
          </div>
        </div>
      </section>
      ...
      {/* --- FAQ SECTION --- */}
      <section id="faq" className="reveal-section relative z-10 py-28 md:py-36 px-6 border-t border-white/5">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              <details key={i} className="group border border-white/10 rounded-2xl transition-all duration-300 hover:border-teal-500/50 open:border-teal-500/50 open:bg-white/[0.02]">
      ...
      {/* --- CONTACT SECTION --- */}
      <section id="contact" className="reveal-section relative z-10 px-6 py-28 md:py-36 border-t border-white/5 bg-[#020408]">
        <div className="max-w-2xl mx-auto flex flex-col items-center text-center gap-10">
          ...
          {contactSuccess ? (
            <div className="w-full p-6 bg-teal-500/10 border border-teal-500 rounded-2xl text-teal-300 text-lg font-medium animate-fade-in">
              ✓ Message sent! We&apos;ll get back to you within 24 hours.
            </div>
          ) : (
            <form onSubmit={handleContactSubmit} className="w-full bg-black/60 backdrop-blur-xl border border-white/10 rounded-2xl p-8 space-y-6 transition-all duration-500 hover:border-teal-500/40 shadow-[0_20px_80px_rgba(45,212,191,0.1)] relative overflow-hidden group/form">
              <div className="absolute top-0 -right-20 w-64 h-64 bg-teal-500/10 blur-[80px] rounded-full pointer-events-none group-hover/form:bg-teal-500/20 transition-colors duration-700" /><div className="absolute -bottom-20 -left-20 w-64 h-64 bg-teal-500/10 blur-[80px] rounded-full pointer-events-none group-hover/form:bg-teal-500/15 transition-colors duration-700" />
              ...
              <input
                ...
                required
                className="w-full px-6 py-4 rounded-xl bg-black/50 border border-white/10 text-white placeholder-gray-600 focus:outline-none focus:border-teal-400 focus:ring-1 focus:ring-teal-400 transition-all"
              />
              <input
                type="email"
              ...
              <textarea
                ...
                required
                rows={4}
                className="w-full px-6 py-4 rounded-xl bg-black/50 border border-white/10 text-white placeholder-gray-600 focus:outline-none focus:border-teal-400 focus:ring-1 focus:ring-teal-400 transition-all resize-none"
              />
              <button
                type="submit"
                disabled={isSubmittingContact}
                className={`w-full py-4 rounded-xl font-bold transition-all duration-300 inline-flex items-center justify-center gap-2 ${isSubmittingContact
  ...
  .animate-pulse-teal { animation: pulse-teal 3s ease-in-out infinite; }
