...
export default function LeedsClient() {
  return (
    <HomeClient hideHero>
        ...
        <div className="relative z-[1] max-w-[var(--content-max)] mx-auto px-5 md:px-[var(--gutter)] py-[clamp(48px,7vw,100px)]">
          <FadeUp>
            <div className="section-label mb-4 md:mb-6">
              <span>AI Automation for Trades in Leeds</span>
            </div>
          </FadeUp>
          <FadeUp delay={0.1}>
            <h1
          ...
          <FadeUp delay={0.2}>
            <p className="text-sm md:text-[17px] leading-[1.75] max-w-[600px] mb-8 md:mb-10" style={{ fontFamily: "var(--font-body)", color: "var(--text-secondary)" }}>
              Leeds tradespeople are turning down work because they can&apos;t handle the admin that comes with it. We build the systems that let you say yes to more jobs without hiring more office staff.
            </p>
          </FadeUp>
          <FadeUp delay={0.3}>
      ...
      >
        <div className="max-w-[var(--content-max)] mx-auto px-5 md:px-[var(--gutter)]">
          <FadeUp className="mb-10 md:mb-14">
            ...
            <h2 className="h1">YORKSHIRE&apos;S TRADES<br />DESERVE BETTER SYSTEMS.</h2>
          </FadeUp>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">
            ...
            >
              ...
              <p className="text-[13px] md:text-sm leading-[1.75]" style={{ fontFamily: "var(--font-body)", color: "rgba(255,255,255,.5)" }}>
                Leeds is the largest economy in the North of England outside Manchester. The South Bank regeneration alone is creating thousands of new homes and commercial units. Trade businesses across West Yorkshire have more work than they know what to do with.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-[13px] md:text-sm leading-[1.75]" style={{ fontFamily: "var(--font-body)", color: "rgba(255,255,255,.5)" }}>
                Yorkshire winters drive emergency demand through the roof &mdash; burst pipes, boiler breakdowns, storm damage. The trades that capture those calls win big. The ones who miss them lose thousands in a single cold snap.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-[13px] md:text-sm leading-[1.75]" style={{ fontFamily: "var(--font-body)", color: "rgba(255,255,255,.5)" }}>
                One Leeds heating engineer recovered &pound;16,800 in a single winter using our AI call handling system. Every emergency call answered, every job booked, every invoice sent &mdash; automatically.
              </p>
            </motion.div>
          </div>
        </div>
