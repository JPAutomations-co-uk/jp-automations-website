...
export default function FreePromptGuidePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch('/api/lead-prompt-guide', {
        method: 'POST',
    ...
    <main className="relative min-h-screen bg-[#0B0F14] flex items-center justify-center overflow-hidden px-6 py-24">
      ...
      <div className="relative z-10 w-full max-w-xl text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold text-white leading-[1.1] mb-5">
          The Prompt<br />
          <span className="text-teal-400">Engineering Guide</span>
        </h1>

        <p className="text-gray-400 text-[17px] leading-[1.7] mb-8 max-w-md mx-auto">
          The best idea wins — but only if you know how to present it. This is the complete guide to writing prompts that AI fully understands and executes on.
        </p>
        ...
        <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl px-6 py-5 mb-8 text-left">
          ...
          <div className="space-y-3">
            {[
              ...
              'Role, context, constraints & output format — the four layers',
              'Chain of thought — how to make AI reason, not just respond',
              'Few-shot examples — the fastest way to improve output quality',
              'The most common prompt mistakes and exactly how to fix them',
              'Copy-paste templates for coding, writing, research & automation',
            ].map((item) => (
